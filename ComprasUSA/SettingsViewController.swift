...
class SettingsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        tfDolar.text = tc.gerFormattedValue(of: tc.dolar, withCurrency: "")
        tfIOF.text = tc.gerFormattedValue(of: tc.iof, withCurrency: "")
        tfStateTaxes.text = tc.gerFormattedValue(of: tc.stateTax, withCurrency: "")
